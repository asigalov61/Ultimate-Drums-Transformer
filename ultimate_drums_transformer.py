...
Original file is located at
    https://colab.research.google.com/drive/1vN6C-MVl1EMv1xxwvDmI-_QcoAOdCLmu
...
model_checkpoint_file_name = 'U;timate_Drums_Transformer_Small_Trained_Model_8134_steps_0.3745_loss_0.8736_acc.pth'
model_path = full_path_to_models_dir+'/Small_NV/'+model_checkpoint_file_name
if os.path.isfile(model_path):
  ...
  hf_hub_download(repo_id='asigalov61/Ultimate-Drums-Transformer',
                  ...
                  local_dir='/content/Ultimate-Drums-Transformer/Models/Small_NV',
