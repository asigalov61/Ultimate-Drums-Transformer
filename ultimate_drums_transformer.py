...
model_checkpoint_file_name = 'Ultimate_Drums_Transformer_Small_Trained_Model_VER3_NV_6855_steps_0.7159_loss_0.7924_acc.pth'
model_path = full_path_to_models_dir+'/Small_V3_NV/'+model_checkpoint_file_name
if os.path.isfile(model_path):
  ...
  hf_hub_download(repo_id='asigalov61/Ultimate-Drums-Transformer',
                  ...
                  local_dir='/content/Ultimate-Drums-Transformer/Models/Small_V3_NV',
