# -*- coding: utf-8 -*-
"""Ultimate_Drums_Transformer_Velocity_Training_Dataset_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/asigalov61/Ultimate-Drums-Transformer/blob/main/Training-Data/Ultimate_Drums_Transformer_Velocity_Training_Dataset_Maker.ipynb

# Ultimate Drums Transformer Training Dataset Maker (ver. 1.0)
    ...
    try:
        ...
        if len(escore_notes) > 0 and (9 in instruments_list):
            ...
            for c in cscore:
              ...
              chans = sorted(set([x[6] for x in c]))

              if (128 in chans and len(chans) > 1) or (chans == [128]):
                  dcscore.append(c)
            ...
            for d in dcscore:
              chans = sorted(set([x[6] for x in d]))

              if 128 in chans and len(chans) > 1:
            ...
            for d in dcscore:
              ...
              if 128 in chans and len(chans) > 1:
                dt_score_notes.extend([max(0, min(127, dntimes[idx]))])
                idx += 1
              ...
              for e in d:
                ...
                if cha == 9:
                  ...
                  if dt_score_notes:
                    dt_score_notes.extend([dtime+128, ptc+256, vel+384])
                  else:
...
if len(out) != 0:
    ...
    for ss in song:
        ...
        if 0 <= ss < 128:
            ...
            song_f.append(['note', time, dur, 0, 60, 70 ])
        ...
        if 384 <= ss < 392:
            ...
            song_f.append(['note', dtime, dur, 9, pitch, vel ])
