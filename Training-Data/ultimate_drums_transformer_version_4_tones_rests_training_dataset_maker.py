# -*- coding: utf-8 -*-
"""Ultimate_Drums_Transformer_Version_4_Tones_Rests_Training_Dataset_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dZraodLvnhZqORhHG_BQEMTntIQZUCz3
            ...
            for i, d in enumerate(dcscore[:-1]):
              ...
              if drums:
                  if chans != [9]:
                      ...
                      dt_score_notes_vel.extend([ndtime, ht+128])
                  ...
                  for e in d:
                    ...
                    if cha == 9:
                      ...
                      if (abs_time - ntime) < 128:
                          if cdtime != 0:
                            dt_score_notes_vel.extend([cdtime+140, ptc+268, vel+396])
                          else:
                            dt_score_notes_vel.extend([ptc+268, vel+396])

                      pe = pabs_time

              if 9 not in dchans and drums:
                  dt_score_notes_vel.extend([0+268, 0+396])
...
if len(out) != 0:
    ...
    for ss in song:
      ...
      if 128 <= ss < 140:
          ...
          ton = ss-140
          song_f.append(['note', time, dur, 0, 72+ton, 110, 40])
