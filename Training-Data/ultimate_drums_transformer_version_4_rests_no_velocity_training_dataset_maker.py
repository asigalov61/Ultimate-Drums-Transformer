# -*- coding: utf-8 -*-
"""Ultimate_Drums_Transformer_Version_4_Rests_No_Velocity_Training_Dataset_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZmqW4otLNqkKQPffSEEivixneeheUK5L
                  ...
                  for e in d:
                    ...
                    if cha == 9:
                      ...
                      if (abs_time - ntime) < 128:
                        if cdtime != 0:
                          dt_score_notes_vel.extend([cdtime+128, ptc+256])
                        else:
                          dt_score_notes_vel.extend([ptc+256])

                      pe = pabs_time

              if 9 not in dchans and drums:
                  dt_score_notes_vel.extend([0+256])
