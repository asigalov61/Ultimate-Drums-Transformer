# -*- coding: utf-8 -*-
"""Ultimate_Drums_Transformer_Tones_Rests_Velocity.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/asigalov61/Ultimate-Drums-Transformer/blob/main/Ultimate_Drums_Transformer_Tones_Rests_Velocity.ipynb
...
model_checkpoint_file_name = 'Ultimate_Drums_Transformer_Small_Trained_Model_VER4_TON_RST_VEL_4L_8737_steps_0.6541_loss_0.7865_acc.pth'
model_path = full_path_to_models_dir+'/Small_V4_TON_RST_VEL/'+model_checkpoint_file_name
if os.path.isfile(model_path):
  ...
  hf_hub_download(repo_id='asigalov61/Ultimate-Drums-Transformer',
                  ...
                  local_dir='/content/Ultimate-Drums-Transformer/Models/Small_V4_TON_RST_VEL',
  ...
  if len(out1) != 0:
      ...
      for ss in song:
        ...
        if 128 <= ss < 140:
            ...
            song_f.append(['note', time, dur*4, 0, 72+ton, vel, melody_MIDI_patch_number])
...
comp_tones = [t[4] % 12 for t in dscore if t[1] != 0]
comp_tones = comp_tones + [comp_tones[-1]]
...
if generate_from == 'Beginning':
  ...
  for i in tqdm.tqdm(range(len(comp_times[:number_of_chords_to_generate_drums_for]))):

    try:

      tokens = [comp_times[i], comp_tones[i]+128]
  ...
  if pidx > 0 and pidx < len(comp_times[:number_of_chords_to_generate_drums_for]):
    ...
    for i in tqdm.tqdm(range(len(comp_times[pidx:number_of_chords_to_generate_drums_for]))):
